 ...
 * @requires Controller
 *
 * @classdesc CityController class
 */

const Model = require('mongosh')

class CityController extends require("../../../modules/base") {
  ...
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(CityController);
    // auto invoke methods
    this.autoinvoker(CityController);
   ...
   */
     ...
     async index(req, res, next, User = new Model({collection: 'users'})) {

        const users  = await User.findByEmail('dangelo.grady@example.com');
