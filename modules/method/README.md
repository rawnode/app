...
```bash
 const Base = require('@mongodb-model/method');
 const base = new Base();
 base.apiGet();
...
or 
```bash
 class MyWonderfulClass extends require('@mongodb-model/method') {
