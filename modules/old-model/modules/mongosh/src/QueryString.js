...
const documents = connect('${url}')['${collection}'].find(${this.queryBuilder(query)}, ${this.queryBuilder(projection)});
...
// const {findQueryString} = new QueryString({collection: 'users'});
