module.exports = (data = {}) => `<table width="100%" border="0" cellspacing="0" cellpadding="0" class="em_full_wrap" align="center"  bgcolor="#efefef">
<tr>
  ...
  <td align="center" valign="top"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed; background-color:#f8f8f8;">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
          ...
          <tr>
            <td class="em_blue em_font_22" align="center" valign="top" style="font-family: Arial, sans-serif; font-size: 26px; line-height: 29px; color:#264780; font-weight:bold;">THE WEEKLY PURR</td>
          </tr>
          <tr>
            <td height="22" class="em_h20" style="height:22px; font-size:0px; line-height:0px;">&nbsp;</td>
          </tr>
          <tr>
              <td valign="top" align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="/assets/pilot/images/templates/banner.jpg" width="600" height="230" class="em_full_img" alt="Alt tag goes here" border="0" style="display:block; max-width:600px; font-family:Arial, sans-serif; font-size:17px; line-height:20px; color:#000000; font-weight:bold;" /></a></td>
          </tr>
          <tr>
              <td valign="top" align="left" bgcolor="#ffffff" style="padding-left:25px; padding-right:35px; background-color:#ffffff;" class="em_aside10">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                  ...
                  <tr>
                    <td class="em_blue em_center" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 20px; line-height: 24px; color:#264780; font-weight:bold;">Introducing Meowverse</td>
                  </tr>
                  <tr>
                    <td height="8" style="height:8px; font-size:0px; line-height:0px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td class="em_grey em_center" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color:#434343;">We’re excited to announce Meowverse - a place for cat lovers to hang out with other cat lovers. Kind of like a cat cafe - but with your own cat, at home. (Okay, it’s nothing like a&nbsp;cat&nbsp;cafe.)</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td valign="top">
                        <table width="290" border="0" cellspacing="0" cellpadding="0" align="left" style="width:290px; background-color:#ffffff;" bgcolor="#ffffff" class="em_wrapper">
                          <tr>
                            <td valign="top" align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="/assets/pilot/images/templates/cat_3.jpg" width="290" height="220" class="em_full_img2" alt="Alt tag goes here" border="0" style="display:block; max-width:290px; font-family:Arial, sans-serif; font-size:17px; line-height:20px; color:#000000; font-weight:bold;" /></a></td>
                          </tr>
                          <tr>
                            <td valign="top" align="left" bgcolor="#ffffff" style="padding-left:25px; padding-right:30px; background-color:#ffffff;" class="em_aside10">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                  ...
                                  <tr>
                                    <td class="em_blue em_center" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 20px; line-height: 24px; color:#264780; font-weight:bold;">Cat of the Week: Luanne</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                      <td valign="top" align="left" height="155" style="height:155px;" class="em_hauto">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                          <tr>
                                            <td class="em_grey em_center" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color:#434343;">Luanne loves standing on tall guitar amps and sleeping on warm beds. Learn more about Luanne and get the real story behind those&nbsp;eyes.</td>
                                          </tr>
                                          <tr>
                        ...
                        <table width="290" border="0" cellspacing="0" cellpadding="0" align="right" style="width:290px; background-color:#ffffff;" bgcolor="#ffffff" class="em_wrapper">
                          <tr>
                            <td valign="top" align="center" class="em_border"><a href="#" target="_blank" style="text-decoration:none;"><img src="/assets/pilot/images/templates/cat_2_large.jpg" width="290" height="220" class="em_full_img2" alt="Alt tag goes here" border="0" style="display:block; max-width:290px; font-family:Arial, sans-serif; font-size:17px; line-height:20px; color:#000000; font-weight:bold;" /></a></td>
                          </tr>
                          <tr>
                            <td valign="top" align="left" bgcolor="#ffffff" style="padding-left:25px; padding-right:30px; background-color:#ffffff;" class="em_aside10">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                  ...
                                  <tr>
                                    <td class="em_blue em_center" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 20px; line-height: 24px; color:#264780; font-weight:bold;">You and Your Kitty</td>
                                  </tr>
                                  <tr>
                                    <td height="10" style="height:10px; font-size:0px; line-height:0px;">&nbsp;</td>
                                  </tr>
                                  <tr>
                                      <td valign="top" align="left" height="155" style="height:155px;" class="em_hauto">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                          <tr>
                                            <td class="em_grey em_center" align="left" valign="top" style="font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color:#434343;">Sure, kittens are cute, but they’re also really annoying and needy. We put together this checklist so your love/hate relationship with your new kitty starts off on the right&nbsp;foot.</td>
                                          </tr>
                                          <tr>
                                            <td height="10" class="em_h15" style="height:10px; font-size:1px; line-height:1px;">&nbsp;</td>
                                          </tr>
