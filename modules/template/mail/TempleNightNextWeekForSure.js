 ...
 *
 * @module TempleNightNextWeekForSure
 * @kind class
 *
 * @extends Base
 * @requires Base
 *
 * @classdesc TempleNightNextWeekForSure class
 */

require("@afrosintech/env");
const { createReadStream } = require("fs");
const mail = require("mail-newsletter");

class TempleNightNextWeekForSure extends require("@afrosintech/mailgun-mail") {
  constructor(...arrayOfObjects) {
    ...
    // auto bind methods
    this.autobind(TempleNightNextWeekForSure);
    // auto invoke methods
    this.autoinvoker(TempleNightNextWeekForSure);
  ...
  email(data = this.data, html =  '') {
    const readable = createReadStream("../resources/mail/temple-night-next-week-for-sure.html", {
      encoding: "utf-8"
    });
...
module.exports = TempleNightNextWeekForSure;
